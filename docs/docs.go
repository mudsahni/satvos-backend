    ...
    "paths": {
        ...
        "/auth/social-login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Social provider and ID token",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Social login not enabled",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponseBody"
                        }
                    }
        ...
        "/documents/{id}/assign": {
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request, document not parsed, or assignee cannot review",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponseBody"
                        }
                    },
                    ...
                    "404": {
                        "description": "Document or assignee not found",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponseBody"
                        }
                    }
        ...
        "/reports/buyers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by seller GSTIN",
                        "name": "seller_gstin",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.BuyerSummaryRow"
                                            }
                                        },
                                        "meta": {
                                            "$ref": "#/definitions/handler.PagMeta"
        ...
        "/reports/collections-overview": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by buyer GSTIN",
                        "name": "buyer_gstin",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.CollectionOverviewRow"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.FinancialSummaryRow"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.HSNSummaryRow"
                                            }
                                        },
                                        "meta": {
                                            "$ref": "#/definitions/handler.PagMeta"
        ...
        "/reports/party-ledger": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Party GSTIN (required)",
                        "name": "gstin",
                        "in": "query",
                        "required": true
                    },
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.PartyLedgerRow"
                                            }
                                        },
                                        "meta": {
                                            "$ref": "#/definitions/handler.PagMeta"
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.SellerSummaryRow"
                                            }
                                        },
                                        "meta": {
                                            "$ref": "#/definitions/handler.PagMeta"
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.TaxSummaryRow"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "domain.CollectionOverviewRow": {
            ...
            "properties": {
                ...
                "validation_invalid_pct": {
                    "type": "number"
                },
                "validation_valid_pct": {
                    "type": "number"
                },
                "validation_warning_pct": {
                    "type": "number"
                }
            }
        },
